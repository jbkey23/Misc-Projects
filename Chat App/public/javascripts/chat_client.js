window.onload = function() { 
    ...
    function populateMembers()
    {
        getCurJsonGroups();
        getCurGroup();
        var membersoptions = '<option value="default">All Group Members</option>' ;
        for(var i = 0; i < curGroup.members.length; i++)
        {
            ...
            groupmembers.innerHTML = membersoptions;     
    }
    ...
    {
        socket.emit('join',{groupname: groupName, username: userName, newgroup: newGroup, socketid: socketId});
    }
    ...
    joingroup.onclick = function()
    {
        ...
        if(groupselector.selectedIndex === 0)
        {
            ...
            {
                if(groupExists(curGroupList,groupName))
                {
